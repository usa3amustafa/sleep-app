...
<html lang="en">
  <head>
    ...
    <title>Children - Helping Against Insomnia, Snoring and Fibromyalgia.</title>
  ...
  <body>
    ...
    <section class="children-text">
      <div class="container grid-two-col children-text-section">
        <div class="children-text-section-left-col grid-two-col-left-col">
          <h2 class="children-text-section-heading grid-two-col-heading">Children with sleep issues
          </h2>
          <p class="children-text-section-desc grid-two-col-desc">
            <strong>There can be many and varied reasons for children to not sleep well at night.</strong> They might be hyperactive, they might have slept during the day and so are not so tired at night, there could be a noise issue, etc. The problem is, is that if your children don’t sleep well, then usually, nor do you!!
            <br />
            <br />
            <br />
            Are you now ready to try something that’s working for many parents world-wide?
          </p>
        </div>
        <div class="children-text-section-right-col grid-two-col-right-col"></div>
      </div>
    </section>
