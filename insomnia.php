...
<html lang="en">
  <head>
    ...
    <title>Insomnia - Helping Against Insomnia, Snoring and Fibromyalgia.</title>
  ...
  <body>
    ...
    <section class="text">
      <div class="container text-section">
        <h2 class="text-section-heading">Do you suffer from insomnia?</h2>
        <p class="text-section-desc">
          <strong> Insomnia – sleepless nights </strong> If you suffer from
          insomnia – also called sleeplessness, you won’t need anyone to explain
          to you what that means, but, one of the things it
          <strong>will</strong> probably mean to you, is the constant feeling of
          tiredness, feeling tired most days! Going by the emails received, for
          example, “I suffer from insomnia, what can I do?” and “My partner
          suffers from insomnia, what can we do?” for these people, the idea of
          a good nights sleep seems so far away, but it doesn’t need to be like
          that.
        </p>
      </div>
    </section>

    <!-- insomnia text section -->
    <section class="insomnia-text">
      <div class="container grid-two-col insomnia-text-section">
        <div class="insomnia-text-section-left-col grid-two-col-left-col">
          <h2 class="insomnia-text-section-heading grid-two-col-heading">Insomnia</h2>
          <p class="insomnia-text-section-desc grid-two-col-desc">
            With the trend nowadays veering more towards the healthier, natural
            solutions, it makes sense to look at sleeping solutions that are
            absolutely natural. The Sleep Better Pillow Mist on this website
            contains Lavender, Chamomile and Eucalyptus, to soothe you into a
            restful sleep.
          </p>
        </div>
        <div class="insomnia-text-section-right-col grid-two-col-right-col"></div>
      </div>
    </section>

    <!-- insomnia image -->
    <div class="insomnia-img container">
      <img src="./_a_img/image.webp" alt="" />
    </div>
