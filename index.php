...
<html lang="en">
  <head>
    ...
    <title>Home - Helping Against Insomnia, Snoring and Fibromyalgia.</title>
  ...
  <body>
    ...
    <section class="home-text">
      <div class="container grid-three-two home-text-section">
        <div class=".home-text-section-left-col">
          <h2 class="home-text-section-title">How did you sleep last night?</h2>
          <p class="home-text-section-desc">
            Do you sometimes find it hard to go to sleep? Do you wake up during the night?
            <br /><br />
            On average, you need at least 8 hours sleep a night in order to function well during the next day, but a high percentage of people very rarely get more than 5 hours sleep a night.
            <br /><br />
            If you don’t sleep properly, the following can happen to you: memory problems, tiredness, dizziness, headaches, depression, irritability, diabetes, unable to concentrate, weight gain. Do any of these ring a bell with you?
            <br /><br />
            There can be many reasons for not sleeping well, including insomnia, snoring and fibromyalgia, these are the usual reasons, BUT, the solutions to sleeping issues don’t need to be the ‘usual’! Many people world-wide are realising that there’s now a more natural, more successful way than taking sleeping tablets and other pills.
            <br /><br />
            The Sleep Better Pillow Mist seen here is helping many people world-wide to sleep better.  Is it now time that it helped you as well?
          </p>
        </div>
        <div class="home-text-section-right-col">
        </div>
      </div>
    </section>
