...
<html lang="en">
  <head>
    ...
    <title>Snoring - Helping Against Insomnia, Snoring and Fibromyalgia.</title>
  ...
  <body>
    ...
    <section class="snoring-text">
      <div class="container grid-two-col snoring-text-section">
        <div class="snoring-text-section-left-col grid-two-col-left-col">
          <h2 class="snoring-text-section-heading grid-two-col-heading">Snoring issues – does your partner snore?​
          </h2>
          <p class="snoring-text-section-desc grid-two-col-desc">
            <strong>Is it fair?</strong> Your partner snores through the night, and has a fairly good nights sleep, while you keep waking up because of their snoring? Of course that isn’t fair! Then the next day, they say they had a good nights sleep, and you’re feeling like you’ve been awake for ever!!
            <br />
            <br />
        ...
        <div class="snoring-text-section-right-col grid-two-col-right-col"></div>
      </div>
    </section>
