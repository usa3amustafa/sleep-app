...
<html lang="en">
  ...
  <body>
    ...
    <!-- menopause text section -->
    <section class="menopause-text">
      <div class="container grid-two-col menopause-text-section">
        <div class="menopause-text-section-left-col grid-two-col-left-col">
          <h2 class="menopause-text-section-heading grid-two-col-heading">Menopause
          </h2>
          <p class="menopause-text-section-desc grid-two-col-desc">
            The menopause is the time that marks the end of menstrual cycles. It’s diagnosed after 12 months have gone without a menstrual period. Menopause usually happens between the age of 40 to 60, with the average age of having menopause symptoms being 50.
            <br />
            <br />
            The menopause is a natural biological process, but the physical symptoms, such as hot flushes, and emotional symptoms of menopause usually disrupt your sleep, lower your energy and / or affect emotional health. There’s many effective treatments available, from lifestyle adjustments to hormone therapy. However one of the symptoms of the menopause besides hot flushes, depression, anxiety and night sweats can often be lack of sleep. Is this you? Do you owe it to yourself to at least try a possible solution?
          </p>
        </div>
        <div class="menopause-text-section-right-col grid-two-col-right-col"></div>
      </div>
    </section>
