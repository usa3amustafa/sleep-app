      ...
      <div class="container grid-two-col fibromyalgia-text-section">
        <div class="fibromyalgia-text-section-left-col grid-two-col-left-col">
          ...
          <p class="fibromyalgia-text-section-desc grid-two-col-desc">
            <strong>The majority of people may not be fully aware of fibromyalgia, but for those who do suffer with fibromyalgia, it’s very real.</strong> Fibromyalgia is a long-term condition that usually causes pain all over the body, which inevitably leads to major sleep issues.
            <br />
            <br />
